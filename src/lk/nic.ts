 ...
 * The Registration of Persons Act No.32 of 1968 as amended by Act Nos 28 and 37 of 1971
 * and Act No.11 of 1981 legislates the issuance and usage of NICs.
 *
 *
 * source:
...
const impl: Validator = {
  ...
  validate(input: string): ValidateReturn {
    ...
    if (!/^[\d]{9}[vVxX]$|^[\d]{12}$/.test(value)) {
      return {
        isValid: false,
        error: new exceptions.InvalidFormat('Invalid NIC format'),
      };
    }
